...
import GUI.Player.Home;
import GUI.Admin.Admin_System;
...
public class Login extends javax.swing.JFrame {
    ...
    private void btn_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_LoginActionPerformed
        ...
        List<Admin> adminList = adao.getAllAdmins();
        ...
        for(Admin ad: adminList){
            if(username.equals(ad.getUsername()) && password.equals(ad.getPassword())){
                Admin_System adminForm = new Admin_System(ad);
        ...
        for(int i=0;i<playerList.size();i++){
            if(username.equals(playerList.get(i).getUsername()) && password.equals(playerList.get(i).getPassword())){
                sb.append("Chào mừng người chơi ");sb.append(playerList.get(i).getFullName());sb.append(" trở lại!");
                Home userForm = new Home(playerList.get(i));
        ...
        if(!isCheck){
            sb.append("Tài khoản này không tồn tại!");
                txt_Password.setBackground(Color.red);
                txt_UserName.setBackground(Color.red);
        }
