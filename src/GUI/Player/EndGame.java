...
public class EndGame extends javax.swing.JFrame {
    ...
    public EndGame(Player player) {
        ...
        if (player.getTotalMoney() == "0") {
            txt_money.setText("Với giải thưởng : 0 VND !!!");
        } else {
            txt_money.setText("Với giải thưởng : " + player.getTotalMoney() + " VND !!!");
        }
        txt_user.setText("Chúc mừng người chơi " + player.getFullName());
    ...
    private void initComponents() {
        ...
        txt_money.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        txt_money.setForeground(new java.awt.Color(255, 255, 255));
        txt_money.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txt_money.setText("Với giải thưởng 100.000.000 VNĐ");
        getContentPane().add(txt_money, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 530, 600, 50));

        txt_user.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        txt_user.setForeground(new java.awt.Color(255, 255, 255));
        txt_user.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txt_user.setText("Chúc Mừng Người : Nguyễn Quyết Thắng ");
        getContentPane().add(txt_user, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 30, 710, 50));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new EndGame(player).setVisible(true);
